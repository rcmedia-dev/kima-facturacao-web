...
import { gerarResumoSAFT, exportarSAFTXML, validarDocumentoSAFT } from "@/lib/saft-generator";
import { Loader2, FileDown, FileJson, FileSpreadsheet, AlertTriangle, ShieldCheck, CheckCircle2 } from "lucide-react";
...
export default function RelatoriosPage() {
  ...
  }, [mounted, store.documentos, store.clientes, store.logs, store.empresa, mes, ano]);
  ...
  const exportarXML = () => {
    ...
    success("SAF-T exportado", "Ficheiro XML gerado com sucesso.");
  };
